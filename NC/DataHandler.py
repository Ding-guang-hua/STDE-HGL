...
class DataHandler:
    ...
    def LoadData(self):
        if args.data == 'DBLP':
            #features_author,APA/APCPA/APTPA
    ...
    def load_dblp_data(self):
        features_a = sp.load_npz(self.predir + 'a_feat.npz').astype("float32") # author
    ...
    def load_aminer_data(self):
        ...
        features_p = sp.eye(type_num[0])#paper
